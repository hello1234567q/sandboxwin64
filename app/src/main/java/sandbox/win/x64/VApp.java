...
import sandbox.win.x64.delegate.MyAppRequestListener;
import sandbox.win.x64.delegate.MyComponentDelegate;
import sandbox.win.x64.delegate.MyPhoneInfoDelegate;
import sandbox.win.x64.delegate.MyTaskDescriptionDelegate;
